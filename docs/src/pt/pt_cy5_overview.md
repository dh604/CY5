...
We build on the SageMath package [boxcounting](https://github.com/liu-henry-hl/boxcounting) [Henry_BoxCounting](@cite) by Henry Liu to compute K-theoretic Pandharipande-Thomas invariants of toric threefolds with a Nekrasov-Okounkov insertion.

## Contents

* [Installation instructions](@ref pt_installation)
...
## [Installation](@id pt_installation)
