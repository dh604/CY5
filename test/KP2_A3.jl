...
get_Omega_beta(G, [2*(H+b)], 2; check_predictions=true)
# Get zero up to genus 2.

get_Omega_beta(G, [2*H+b], 2; check_predictions=true)
# Get zero up to genus 2.

get_Omega_beta(G, [H+2*b], 2; check_predictions=true)
# Get zero up to genus 2.

get_Omega_beta(G, [(H + b + c)], 2; check_predictions=true)
# Get zero up to genus 2.

get_Omega_beta(G, [H + b + 2*c], 2; check_predictions=true)
# Get zero up to genus 2.
